...
module.exports = {
    ...
    async run (client, message, args) {
      ...
      let item = await db.fetch(`inv_${message.guild.id}_${message.author.id}`);
      ...
      if(purchase == "1"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r1}`)
      ...
      if(purchase == "3"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r3}`)
      ...
      if(purchase == "4"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r4}`)
      ...
      if(purchase == "5"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r5}`)
      ...
      if(purchase == "6"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r6}`)
      ...
      if(purchase == "7"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r7}`)
      ...
      if(purchase == "8"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r8}`)
      ...
      if(purchase == "9"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r9}`)
      ...
      if(purchase == "10"){
        ...
        if(item === null){
          ...
          db.push(`inv_${message.guild.id}_${message.author.id}`, `${r10}`)
